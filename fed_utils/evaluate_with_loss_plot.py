...
# === CONFIG ===
FINAL_MODEL_PATH = "./qlora-FedAggregation/10/final_fedavg_model.safetensors"
...
state_dict = torch.load(FINAL_MODEL_PATH, map_location=DEVICE)  # <- simple torch.load, no safetensors.load_file!
model.load_state_dict(state_dict, strict=False)  # allow some missing keys if needed
model.eval()
